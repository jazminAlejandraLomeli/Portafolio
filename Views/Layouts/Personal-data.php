   <div class="col-12 col-md-4 col-xl-4">
       <div class="card_style profile border p-3 position-relative">
           ...
           <div class="card-content ">
               <h3 class="mt-4 fw-semibold">Jazmin A. Lomelí Zermeño</h4>
                   <p class="text-muted">Jr Full-Stack Web Developer</p>
           </div>


           <p class="text-center mb-1"> Redes sociales </p>
           <div class="d-flex justify-content-center align-items-center mb-4 mt-0">
           ...
           <ul class="list-unstyled d-flex row mx-1">
               ...
               <li class="d-flex align-items-center mt-3">
                   ...
                   <span class="ps-1 cont-texto">alejandrazermeno18@gmail.com
                       <br>
           ...
           <div class="d-flex justify-content-center align-items-center p-3">
               <button type="button" class="btn btn-outline-primary">Descargar CV</button>
           </div>
       </div>
